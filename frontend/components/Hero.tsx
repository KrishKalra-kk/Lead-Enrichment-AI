      ...
      <div className="relative z-10 mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between border-b border-white/10 py-5">
          <div className="flex items-center gap-3">
            ...
            <div>
              <div className="text-sm font-semibold tracking-[0.2em] text-slate-200 uppercase">LEADENRICHMENTAI</div>
          ...
          >
            ...
            <div className="space-y-6">
              ...
              <p className="max-w-2xl text-lg leading-8 text-slate-300 sm:text-xl">
                LEADENRICHMENTAI captures submitted company details, researches the business from public sources, generates a polished audit, and delivers it by email without manual intervention.
              </p>
            </div>
